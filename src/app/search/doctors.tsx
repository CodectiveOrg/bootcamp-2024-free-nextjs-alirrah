...
export const doctors: Doctor[] = [
  {
    ...
    brief: MedicalSpecialties.BONES_AND_JOINTS,
  },
  {
    id: 2,
    name: "مجتبی قدسی",
    ...
    brief: MedicalSpecialties.GASTROENTEROLOGY,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    brief: MedicalSpecialties.WOMEN_AND_CHILD_BIRTH,
  },
  {
    id: 5,
    name: "رضا پورعلی",
    ...
    brief: MedicalSpecialties.OPHTHALMOLOGY,
  },
  {
    id: 6,
    name: "نادیا پرور",
  ...
  },
  {
    ...
    firstAvailableAppointment: "کمتر از پنج ساعت دیگر",
    brief: MedicalSpecialties.KIDNEY_AND_URINARY_TRACT,
  },
  {
    id: 16,
    name: "نوید دانائی",
